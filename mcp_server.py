...
DEFAULT_MODELS = [
    ...
    "claude:claude-3-7-sonnet-20250219", # Example, might need changing
    "gemini:gemini-2.0-flash", # Example, might need changing
    "deepseek:bedrock_deepseek_r1" # Example, might need changing
]
...
# AICHAT_COMMAND = "/opt/homebrew/bin/aichat" # No longer needed
# AICHAT_ERROR_PREFIXES = ("aichat command failed", "Error:", "An unexpected error occurred") # No longer needed
